...
#ifdef _MSC_VER
#include <intrin.h>
static __inline UWORD32 ihevc_msvc_clz(UWORD32 value)
{
    unsigned long index;
...
static __inline UWORD32 ihevc_msvc_ctz(UWORD32 value)
{
    unsigned long index;
...
static __inline UWORD32 ihevc_msvc_clzll(unsigned long long value)
{
    unsigned long index;
    if(_BitScanReverse64(&index, value))
        return 63u - (UWORD32)index;
    return 64u;
}
#define __builtin_clz(value) ihevc_msvc_clz((UWORD32)(value))
#define __builtin_ctz(value) ihevc_msvc_ctz((UWORD32)(value))
#define __builtin_clzll(value) ihevc_msvc_clzll((unsigned long long)(value))
