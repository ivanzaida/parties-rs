...
extern "C" {
  pub fn de265_get_image_width(arg1: *const de265_image, channel: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
  pub fn de265_get_image_height(arg1: *const de265_image, channel: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
  pub fn de265_get_chroma_format(arg1: *const de265_image) -> de265_chroma::Type;
}
extern "C" {
  pub fn de265_get_bits_per_pixel(arg1: *const de265_image, channel: ::std::os::raw::c_int) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
  pub fn de265_set_image_user_data(arg1: *mut de265_image, user_data: *mut ::std::os::raw::c_void);
}
extern "C" {
...
extern "C" {
  pub fn de265_get_image_transfer_characteristics(arg1: *const de265_image) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
  pub fn de265_get_number_of_input_bytes_pending(arg1: *mut de265_decoder_context) -> ::std::os::raw::c_int;
}
extern "C" {
  pub fn de265_get_number_of_NAL_units_pending(arg1: *mut de265_decoder_context) -> ::std::os::raw::c_int;
}
extern "C" {
  pub fn de265_decode(arg1: *mut de265_decoder_context, more: *mut ::std::os::raw::c_int) -> de265_error::Type;
}
extern "C" {
...
pub struct de265_image_allocation {
  ...
  pub release_buffer: ::std::option::Option<
    unsafe extern "C" fn(ctx: *mut de265_decoder_context, img: *mut de265_image, userdata: *mut ::std::os::raw::c_void),
  >,
}
extern "C" {
...
extern "C" {
  pub fn de265_set_framerate_ratio(arg1: *mut de265_decoder_context, percent: ::std::os::raw::c_int);
}
extern "C" {
...
extern "C" {
  pub fn de265_get_parameter_bool(arg1: *mut de265_decoder_context, param: de265_param::Type) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
  pub fn en265_list_parameters(arg1: *mut en265_encoder_context) -> *mut *const ::std::os::raw::c_char;
}
...
extern "C" {
  pub fn en265_push_image(arg1: *mut en265_encoder_context, arg2: *mut de265_image) -> de265_error::Type;
}
extern "C" {
...
extern "C" {
  pub fn en265_current_input_queue_length(arg1: *mut en265_encoder_context) -> ::std::os::raw::c_int;
}
extern "C" {
...
extern "C" {
  pub fn en265_get_packet(arg1: *mut en265_encoder_context, timeout_ms: ::std::os::raw::c_int) -> *mut en265_packet;
}
extern "C" {
  pub fn en265_free_packet(arg1: *mut en265_encoder_context, arg2: *mut en265_packet);
}
extern "C" {
  pub fn en265_number_of_queued_packets(arg1: *mut en265_encoder_context) -> ::std::os::raw::c_int;
}
